 ...
 */
final class Version20231027194612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE city (id INT AUTO_INCREMENT NOT NULL, department_id INT NOT NULL, name VARCHAR(255) NOT NULL, zip_code INT NOT NULL, INDEX IDX_2D5B0234AE80F5DF (department_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ride (id INT AUTO_INCREMENT NOT NULL, mind_id INT NOT NULL, practice_id INT NOT NULL, user_creator_id INT NOT NULL, title VARCHAR(255) NOT NULL, distance INT NOT NULL, ascent INT NOT NULL, max_rider INT NOT NULL, average_speed INT NOT NULL, date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', place VARCHAR(255) NOT NULL, INDEX IDX_9B3D7CD053B01993 (mind_id), INDEX IDX_9B3D7CD0ED33821 (practice_id), INDEX IDX_9B3D7CD0C645C84A (user_creator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, city_id INT NOT NULL, mind_id INT NOT NULL, user_name VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, birth_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', file_name VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D64924A232CF (user_name), INDEX IDX_8D93D6498BAC62AF (city_id), INDEX IDX_8D93D64953B01993 (mind_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ride ADD CONSTRAINT FK_9B3D7CD0C645C84A FOREIGN KEY (user_creator_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE ride_user ADD CONSTRAINT FK_C6ACE33D302A8A70 FOREIGN KEY (ride_id) REFERENCES ride (id)');
