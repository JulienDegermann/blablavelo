 ...
 */
final class Version20241017160758 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ride (id INT AUTO_INCREMENT NOT NULL, mind_id INT NOT NULL, practice_id INT NOT NULL, creator_id INT NOT NULL, start_city_id INT NOT NULL, distance INT NOT NULL, ascent INT NOT NULL, max_participants INT NOT NULL, average_speed INT NOT NULL, start_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', title VARCHAR(255) NOT NULL, INDEX IDX_9B3D7CD053B01993 (mind_id), INDEX IDX_9B3D7CD0ED33821 (practice_id), INDEX IDX_9B3D7CD061220EA6 (creator_id), INDEX IDX_9B3D7CD07B693E7C (start_city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ride ADD CONSTRAINT FK_9B3D7CD061220EA6 FOREIGN KEY (creator_id) REFERENCES `user` (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ride ADD CONSTRAINT FK_9B3D7CD07B693E7C FOREIGN KEY (start_city_id) REFERENCES city (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ride DROP FOREIGN KEY FK_9B3D7CD061220EA6');
        $this->addSql('ALTER TABLE ride DROP FOREIGN KEY FK_9B3D7CD07B693E7C');
